...
\part{CodeRed}
\label{part:CodeRed}
%\input{Was ist CodeRed?}
%\input{Wer kann mitmachen?}

\part{Wie Nutze ich CodeRed}
\label{part:Wie Nutze ich CodeRed}
%\input{Wie kann ich CodeRed nutzen?}
%\input{Abläufe}
%\Wer macht was?
%\Was ist ein Ticket?
%\Was ist ein Client?
