class Report < ActiveRecord::Base
        belongs_to :clients
        validates_presence_of :user_id, :datei, :client_id, :beschreibung
  	
	file_column :datei
	validates_file_format_of :datei,
	:in => [
	# shell magie ;)
	# for MIME in `cat /etc/mime.types|grep -v \#|awk '{print $1}'`; do echo "'$MIME'," ; done
